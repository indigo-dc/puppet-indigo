class indigo::params {
    ...
    $indigo_3rdparty_failovermethod = "priority"
    $indigo_3rdparty_priority       = "40"
    $indigo_3rdparty_protect        = "1"
    $indigo_3rdparty_enabled        = "1"
    $indigo_3rdparty_gpgcheck       = "1"
    $indigo_3rdparty_gpgkey         = "file:///etc/pki/rpm-gpg/RPM-GPG-KEY-indigodc"
}
